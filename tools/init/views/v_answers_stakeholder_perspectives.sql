-- analytical view providing average results aggregated on unique organisation ids for outside stakeholder perspectives

CREATE OR REPLACE VIEW V_ANSWERS_STAKEHOLDER_PERSPECTIVES AS
...
FROM
	...
	FROM (
        ...
        -- here we want to get all results from "outside" perspectives for the distinct organisations
		GROUP BY 
			ESGQ.QUESTIONAIRE_TYPE,
			ESG.ESG_MEASURE_ID,
			ESG.ESG_MEASURE_KEY,
...
SELECT
    ...
    CASE
        WHEN MAX(data.ESG_QUESTIONAIRE_ANSWER_PRIORITY_AVG)>outside.ESG_QUESTIONAIRE_ANSWER_PRIORITY_MAX
        THEN MAX(data.ESG_QUESTIONAIRE_ANSWER_PRIORITY_AVG)
        ELSE outside.ESG_QUESTIONAIRE_ANSWER_PRIORITY_MAX
    END AS ESG_QUESTIONAIRE_ANSWER_PRIORITY_MAX,
	SUM(data.ESG_QUESTIONAIRE_ANSWER_PRIORITY_EMPLOYEES_AVG)+outside.ESG_QUESTIONAIRE_ANSWER_PRIORITY_EMPLOYEES_AVG AS ESG_QUESTIONAIRE_ANSWER_PRIORITY_EMPLOYEES_AVG,
	SUM(data.ESG_QUESTIONAIRE_ANSWER_PRIORITY_CLIENTS_AVG)+outside.ESG_QUESTIONAIRE_ANSWER_PRIORITY_CLIENTS_AVG AS ESG_QUESTIONAIRE_ANSWER_PRIORITY_CLIENTS_AVG,
	SUM(data.ESG_QUESTIONAIRE_ANSWER_PRIORITY_SUPPLIERS_AVG)+outside.ESG_QUESTIONAIRE_ANSWER_PRIORITY_SUPPLIERS_AVG AS ESG_QUESTIONAIRE_ANSWER_PRIORITY_SUPPLIERS_AVG,
	SUM(data.ESG_QUESTIONAIRE_ANSWER_PRIORITY_INDUSTRY_REP_AVG)+outside.ESG_QUESTIONAIRE_ANSWER_PRIORITY_INDUSTRY_REP_AVG AS ESG_QUESTIONAIRE_ANSWER_PRIORITY_INDUSTRY_REP_AVG,
	SUM(data.ESG_QUESTIONAIRE_ANSWER_PRIORITY_SOCIETY_AVG)+outside.ESG_QUESTIONAIRE_ANSWER_PRIORITY_SOCIETY_AVG AS ESG_QUESTIONAIRE_ANSWER_PRIORITY_SOCIETY_AVG,
	SUM(data.ESG_QUESTIONAIRE_ANSWER_PRIORITY_BANK_AVG)+outside.ESG_QUESTIONAIRE_ANSWER_PRIORITY_BANK_AVG AS ESG_QUESTIONAIRE_ANSWER_PRIORITY_BANK_AVG,
	SUM(data.ESG_QUESTIONAIRE_ANSWER_PRIORITY_REGULATOR_AVG)+outside.ESG_QUESTIONAIRE_ANSWER_PRIORITY_REGULATOR_AVG AS ESG_QUESTIONAIRE_ANSWER_PRIORITY_REGULATOR_AVG,
	SUM(data.ESG_QUESTIONAIRE_ANSWER_PRIORITY_TERRAMO_AVG)+outside.ESG_QUESTIONAIRE_ANSWER_PRIORITY_TERRAMO_AVG AS ESG_QUESTIONAIRE_ANSWER_PRIORITY_TERRAMO_AVG,
	SUM(data.ESG_QUESTIONAIRE_ANSWER_PRIORITY_TERRAMO_AVG)+outside.ESG_QUESTIONAIRE_ANSWER_PRIORITY_TERRAMO_AVG*-1 AS ESG_QUESTIONAIRE_ANSWER_PRIORITY_TERRAMO_NEG_AVG,
	SUM(data.ESG_QUESTIONAIRE_ANSWER_STATUS_EMPLOYEES_AVG)+outside.ESG_QUESTIONAIRE_ANSWER_STATUS_EMPLOYEES_AVG AS ESG_QUESTIONAIRE_ANSWER_STATUS_EMPLOYEES_AVG,
	SUM(data.ESG_QUESTIONAIRE_ANSWER_STATUS_CLIENTS_AVG)+outside.ESG_QUESTIONAIRE_ANSWER_STATUS_CLIENTS_AVG AS ESG_QUESTIONAIRE_ANSWER_STATUS_CLIENTS_AVG,
	SUM(data.ESG_QUESTIONAIRE_ANSWER_STATUS_SUPPLIERS_AVG)+outside.ESG_QUESTIONAIRE_ANSWER_STATUS_SUPPLIERS_AVG AS ESG_QUESTIONAIRE_ANSWER_STATUS_SUPPLIERS_AVG,
	SUM(data.ESG_QUESTIONAIRE_ANSWER_STATUS_INDUSTRY_REP_AVG)+outside.ESG_QUESTIONAIRE_ANSWER_STATUS_INDUSTRY_REP_AVG AS ESG_QUESTIONAIRE_ANSWER_STATUS_INDUSTRY_REP_AVG,
	SUM(data.ESG_QUESTIONAIRE_ANSWER_STATUS_SOCIETY_AVG)+outside.ESG_QUESTIONAIRE_ANSWER_STATUS_SOCIETY_AVG AS ESG_QUESTIONAIRE_ANSWER_STATUS_SOCIETY_AVG,
	SUM(data.ESG_QUESTIONAIRE_ANSWER_STATUS_BANK_AVG)+outside.ESG_QUESTIONAIRE_ANSWER_STATUS_BANK_AVG AS ESG_QUESTIONAIRE_ANSWER_STATUS_BANK_AVG,
	SUM(data.ESG_QUESTIONAIRE_ANSWER_STATUS_REGULATOR_AVG)+outside.ESG_QUESTIONAIRE_ANSWER_STATUS_REGULATOR_AVG AS ESG_QUESTIONAIRE_ANSWER_STATUS_REGULATOR_AVG,
	SUM(data.ESG_QUESTIONAIRE_ANSWER_STATUS_TERRAMO_AVG)+outside.ESG_QUESTIONAIRE_ANSWER_STATUS_TERRAMO_AVG AS ESG_QUESTIONAIRE_ANSWER_STATUS_TERRAMO_AVG,
	SUM(data.ESG_QUESTIONAIRE_ANSWER_STATUS_TERRAMO_AVG)+outside.ESG_QUESTIONAIRE_ANSWER_STATUS_TERRAMO_AVG*-1 AS ESG_QUESTIONAIRE_ANSWER_STATUS_TERRAMO_AVG_NEG
FROM
	(
	SELECT
		consolidated.ORGANISATION_ID,
	...
	FROM (
		...
		ON ESGM.ESG_MEASURE_ID = consolidated.ESG_MEASURE_ID
			AND ESGM.ESG_MEASURE_DESCRIPTION_COUNTRY_ISO = 'DE'
) data LEFT JOIN outside ON outside.ESG_MEASURE_ID = data.ESG_MEASURE_ID
GROUP BY
		data.ORGANISATION_ID,
		data.ORGANISATION_NAME,
		data.QUESTIONAIRE_TYPE,
